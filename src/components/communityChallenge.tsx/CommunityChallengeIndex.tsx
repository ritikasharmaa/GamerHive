  ...
  return (
    <div className="flex flex-wrap justify-evenly gap-0">
      <div className="flex flex-col gap-5 items-center">
            ...
            <>
              ...
              <div className="flex justify-around md:gap-12 mt-6 w-full items-center">
                <div className="flex flex-col">
                  ...
                  <p className="uppercase text-white text-lg">Ritika Sharma</p>
        ...
        <div>
          <div className="flex w-[93%] justify-center">
            <div className="lg:h-[3rem] md:h-[2.99rem] bg-[#0B111F] premiumBox3 relative top-[4rem] md:top-[3.7rem] w-[72%] left-[0.5rem] md:left-4 h-12 md:w-[56%] lg:w-[48%] "></div>
          </div>
          <p className="text-[#A3C7D7] text-[10px] top-4 md:-left-1 md:text-base relative md:top-5 text-center">
            COMMUNITY CHALLENGE
          </p>
          {/* second shape */}
        ...
        <div>
          <div className="flex w-[93%] justify-center">
            <div className="lg:h-[3rem] md:h-[2.99rem] bg-[#0B111F] premiumBox3 relative top-[3.4rem] md:top-[3.3rem] w-[72%] left-[0.5rem] md:left-4 h-12 md:w-[45%] lg:w-[48%] "></div>
          </div>
          <p className="text-[#A3C7D7] -left-3 md:left-0 text-lg relative top-3 text-center">
            PRIZE
          </p>
            ...
            <div className="w-[38rem] md:h-[16rem]   h-[18rem] border-[#43E5F1]  bg-[#000000] MeagPrizeBoxInnder2">
              <div className="flex flex-col items-center gap-4 pt-12 ">
                {megaChallengeData.map((item) => {
                  return (
                    <div
                      className="flex  h-14 justify-between pr-10 pl-10 items-center megaChallengeIndivitualRow text-white"
                      key={item.id}
                    >
                      ...
                      <div className="flex justify-evenly w-[45%] items-center gap-1">
                        ...
                        <p className="blackBoxFont text-4xl  text-white">
                          {" "}
                          {item.points}{" "}
                        </p>
                      </div>
      ...
      <div className="h-[50rem] mt-16 lg:-mt-20">
        <div className="flex w-[93%] justify-center">
          <div className="lg:h-[3.2rem] md:h-[3.2rem] bg-[#0B111F] premiumBox3 relative top-[3.9rem] md:top-[3.4rem] w-[81%] left-[0.7rem] md:left-5 h-16 md:w-[72%] lg:w-[48%] "></div>
        </div>
