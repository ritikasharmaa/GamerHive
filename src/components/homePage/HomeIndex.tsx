...
const HomeIndex = () => {
  ...
  return (
    <div className="homeIndexMainParent">
      <div>
        <p className="heroIntroduceFont font-extralight interFont text-center text-sm">
          INTRODUCING GAMERHIVE
        </p>
        <br />
        <div className="heroText lg:text-9xl  md:text-7xl text-7xl text-center">
          GAME ON GET FIT
        </div>
