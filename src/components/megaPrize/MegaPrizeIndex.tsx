...
const MegaPrizeIndex = () => {
  ...
  const leaderboardDataTop10 = leaderboardDataAllPlayers.filter(
    (item) => item.id < 10
  ); //after u get fetch the data of all the players from the backend you  can store that in "leaderboardDataAllPlayers" and then we run the ".filter" function to filter out only the top 10 players based on the rank (id)
    ...
    <div>
      <div className="flex flex-wrap justify-evenly gap-0">
        <div className="flex flex-col gap-5 items-center md:mb-28 lg:mb-24 xl:mb-0">
            ...
            {loggedIn === false ? (
              <>
                ...
                <p className=" capitalize box1Description montestratFont w-[83%]">
                  Get ready for the ultimate gaming event of the year! Compete
                  against top gamers from around the world and showcase your
                  in-game skills to score points and climb the leaderboard. all
                  players have a chance to win the coveted Mega Prize.
                  Don&apos;t miss out on this unforgettable gaming experience!
                </p>
                ...
                <div className="flex items-center justify-between mt-7">
                  <div className="flex items-center gap-1">
                    ...
                    <div className=" font-bold text-red-600 text-sm md:text-xl">
                      {" "}
                      12:00:01{" "}
                      <span className="text-red-600 text-sm md:text-base -ml-1">
                        s
                      </span>
                    </div>
                  </div>
                  ...
                  <button
                    className="text-white dashBoardHeroBtn uppercase h-9 w-28"
              ...
              <>
                <div className="flex justify-end">
                  <div
                    className="gap-3 items-center rounded-full w-28 flex justify-center h-10 border-yellow-500 border bg-black"
                    onClick={() => setLoggedIn(!loggedIn)}
                  >
                ...
                <div className="flex justify-between md:justify-around md:gap-12 mt-6 w-full items-center">
                  <div className="flex flex-col">
                    <Image
                      ...
                      alt=""
                      quality={100}
                      className="w-24 border-white border border-solid rounded-full"
                    />
                    <div className="flex justify-end">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="md:text-8xl text-7xl text-white blackBoxFont">
                      222
                    </p>
                  </div>
                </div>
          ...
          <div className=" relative xl:-top-12 w-full">
            <div className="flex w-[93%] justify-center">
              <div className="lg:h-[3rem] md:h-[2.99rem] bg-[#0B111F] premiumBox3 relative top-[4.4rem] md:top-[4.7rem] w-[72%] left-[0.5rem] md:left-0 h-12 md:w-[45%] lg:w-[48%] "></div>
            </div>
            <p className="text-[#A3C7D7] text-xs -left-2 md:left-0 md:text-base relative top-10 text-center">
              MEGA CHALLENGE
            </p>
              ...
              <div className="w-[38rem] h-[21rem] maegaPrizeBox2 border-[#43E5F1]  bg-[#000000] MeagPrizeBoxInnder">
                <div className="flex flex-col items-center gap-4 pt-12 ">
                  {megaChallengeData.map((item) => {
                    return (
                      <div
                        className="flex  h-14 justify-evenly items-center megaChallengeIndivitualRow text-white"
                        key={item.id}
                      >
                        <p> 0{item.id} </p>
          ...
          <div className=" relative xl:-top-20">
            <div className="flex w-[93%] justify-center">
              <div className="lg:h-[3rem] md:h-[2.99rem] bg-[#0B111F] premiumBox3 relative top-[3.2rem] md:top-[2.7rem] w-[81%] left-[0.5rem] md:left-4 h-16 md:w-[45%] lg:w-[48%] "></div>
            </div>

            <p className="text-[#A3C7D7] -left-3 md:left-0 text-lg relative top-1 text-center">
              PRIZE
            </p>
            <div className="w-[38rem] md:h-[12.1rem] h-[18.1rem]   border-[#43E5F1] border-[1px] bg-[#43E5F1]  ThirdShapecss2Iphone ">
              <div className="w-[38rem] md:h-[12rem]   h-[18rem] border-[#43E5F1]  bg-[#000000] MeagPrizeBoxInnder2">
                <div className="flex justify-center items-center w-full h-fit min-h-[16rem]">
                  <p className="text-white md:text-4xl text-[2.56rem] lg:text-5xl w-full h-full text-center">
                    WIN AN IPHONE
                  </p>
                </div>
              </div>
        ...
        <div className="h-[50rem] mt-16 lg:-mt-20">
          <div className="flex w-[93%] justify-center">
            <div className="lg:h-[3.2rem] md:h-[2.99rem] bg-[#0B111F] premiumBox3 relative top-[3.9rem] md:top-[3.4rem] w-[81%] left-[0.7rem] md:left-5 h-16 md:w-[39%] lg:w-[48%] "></div>
          </div>

          <p className="text-[#A3C7D7]  md:text-xl w-full text-center top-4 md:-left-[0.3rem] relative">
            LEADERBOARD
          </p>
            ...
            <div className="w-[40rem] h-[100%] bg-[#000000]  FirstShapecss ">
              <div className="flex flex-col pt-20 gap-2 items-center">
                ...
                {leaderboardDataTop10.map((item) => {
                  ...
                  return (
                    <div
                      className="flex items-center w-full h-12 justify-around gap-3 leaderBoardIndivitualRow"
                      key={item.id}
                    >
                      <p className={rankClass}>
                        {" "}
                        {item.id < 4 && <span>#</span>} {item.id}{" "}
                      </p>
                      <p className="text-white font-light uppercase text-xl">
                        {item.title}{" "}
                      </p>
