    ...
    <div className="text-white relative left-2">
      <div className="flex items-start md:ml-4 lg:ml-0 relative top-24 gap-20 md:gap-0 md:top-0 flex-wrap justify-evenly">
        <div className="flex flex-col lg:w-[45%] w-full">
          <p className=" uppercase text-xl mb-1 text-gray-400 tracking-[0.17em] font-bold">
            my details
          </p>
          ...
          <div className="flex flex-col gap-4">
            ...
            <input
              type="text"
              className="md:w-[60%] w-[85%] bg-transparent border-0 outline-none placeholder-[#4E4E4E]  border-b-2 pb-2"
              placeholder="JOHNDOE"
              value={userName}
          ...
          <p className="uppercase text-lg mb-2 mt-2 tracking-[0.17em]">
            Country
          </p>
          ...
          <Image
            ...
            alt=""
            quality={100}
            className="w-24 relative  -left-5"
          />
          ...
          <p className="text-xl text-gray-400 mb-3 tracking-[0.17em] uppercase font-bold">
            Subscription
          </p>
          ...
          <div className="settingsSubscriptionBoxHold relative -left-[0.2rem] md:-left-0">
            ...
            <div className="flex justify-center  md:gap-16 gap-4 w-full items-center">
              <p className="md:text-xl font-light tracking-[0.17em]">
                22/12/23
              </p>
              <p className="md:text-xl uppercase text-green-500 tracking-[0.17em]">
                active
              </p>
        ...
        <div className="flex flex-col lg:w-[45%] w-full">
          <p className=" uppercase text-xl mb-2 text-gray-400 tracking-[0.17em] font-bold">
            my social links
          </p>

          <div className="settingsHorizontalDivider mb-2"></div>

          <p className="text-xl text-white mt-4 mb-5 uppercase tracking-[0.17em]">
            discord
          </p>
          <div className="flex cursor-pointer w-[90%] items-center mb-4 settingsSocialsButton mr-2 md:mr-0">
            <p>Connected with VioletVortex </p>
            <Image src={discord} alt="" quality={100} />
          </div>

          <br />

          <p className=" uppercase text-xl mb-2 text-gray-400 mt-2 tracking-[0.17em] font-bold">
            GAME ACCOUNT
          </p>
          <div className="settingsHorizontalDivider mb-5"></div>

          <p className="text-xl text-white mb-3 uppercase tracking-[0.17em]">
            Riot
          </p>
