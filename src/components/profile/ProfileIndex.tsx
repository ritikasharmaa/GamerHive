    ...
    <div>
      <div className="flex mt-24 md:mt-0 justify-evenly items-start gap-28 md:gap-24 lg:gap-0 flex-wrap">
        ...
        <div className="w-96 h-[38rem] relative lg:-top-9 md:-left-0">
          <p className="text-[#A3C7D7] text-2xl relative top-5 -left-4 text-center">
            MY STATS
          </p>
              ...
              <div className="pt-12">
                ...
                <div className="flex justify-center gap-4 mt-6 items-center mr-3">
                  <Image
                    ...
                    alt=""
                    quality={100}
                    className="w-24 h-24 border-white border-solid border-1 rounded-full"
                  />

                  <div className="flex flex-col gap-2 items-center">
                    <p className="uppercase text-xl">RITIKA SHARMA</p>

                    <div className="flex items-end gap-1">
                      <p className="text-gray-400 font-light relative -top-3 tracking-widest">
                        TOKENS
                      </p>
                ...
                <div className="profileDivider w-[90%] h-[1px] ml-5 mt-2"></div>
                  ...
                  {statsData.map((item) => {
                    return (
                      <div
                        ...
                        key={item.type}
                      >
                        <p className="text-gray-200 capitalize font-light tracking-wide text-xs">
                          {item.type}
                        </p>
                    ...
                    <div className="flex justify-between w-[90%] mx-auto">
                      <div className="flex gap-7 items-center">
                        <div className="flex gap-2 items-center">
                          <div className="bg-[#FF0F00] rounded-full w-3 h-3"></div>
                          <p className="text-xs">KILLS</p>
                        </div>

                        <div className="flex gap-2 items-center">
                          <div className="bg-[#0038FF] rounded-full w-3 h-3"></div>
                ...
                <div className="w-[100%] h-[100%] custom-shapeMobile2 custom-shape2 text-white bg-[#060709] opacity-[99]">
                  <div className=" flex justify-center flex-wrap items-center w-full h-full">
                    <div className="flex items-center md:gap-28 gap-8 flex-wrap justify-around">
                      ...
                      <div className="flex items-center gap-6 flex-col">
                        <p>Total</p>
                        <p className="blackBoxFont md:text-7xl text-4xl">
                          5061
                        </p>
                      </div>
                ...
                <div className="w-[100%] h-[100%] custom-shapeMobile2 challengeHistory-shape2 text-white bg-[#060709] opacity-[99]">
                  <div className="flex flex-col items-center gap-4 lg:mt-12 mt-14">
                    {megaChallengeData.map((item) => {
                      return (
                        <div
                          className="flex  h-12 justify-evenly items-center megaChallengeIndivitualRow text-white"
                          key={item.id}
                        >
                          <p className="text-sm md:text-base"> {item.id} </p>
                          <div className="flex items-center font-light text-gray-500 text-xs md:text-base">
                            <span>{item.day}</span>/<span>{item.month} </span>/
                            <span> {item.year} </span>
                          </div>
                          ...
                          <div className="flex flex-col items-center">
                            <p className="text-yellow-400 text-xs md:text-base">
                              {item.points}
                            </p>
                            <p className=" text-[10px] text-[#555454]">
                              {" "}
                              TOKENS EARNED{" "}
                            </p>
                          </div>
